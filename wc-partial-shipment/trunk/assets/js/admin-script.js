            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    html += '<div class="wxp_partial_ship_foot">\
                        ...
                        <div class="wxp-button-foot"><button type="button" data-check="' + data.check + '" data-order-id="' + data.order_id + '" class="button button-primary wxp-shipment-bulk-action" name="save">' + wxp_partial_ship.wxp_update + '</button></div>\
                        </div>\
                        </div>';
        ...
        wxp_order_item_shipment: function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    html += '<div class="wxp_partial_ship_foot">\
                        <div class="wxp-select-foot"><button data-check="' + data.check + '" data-item-id="' + data.item_id + '" data-order-id="' + data.order_id + '" data-type="shipped" type="button" class="button button-primary wxp-item-action" name="save">' + wxp_partial_ship.wxp_bulk_mark_shipped + '</button></div>\
                        <div class="wxp-button-foot"><button data-check="' + data.check + '" data-item-id="' + data.item_id + '" data-order-id="' + data.order_id + '" data-type="not-shipped" type="button" class="button button-primary wxp-item-action" name="save">' + wxp_partial_ship.wxp_bulk_mark_not_shipped + '</button></div>\
                        </div>\
                        </div>';
                    wxp_meta_boxes_order_items.unblock();
                    $.fancybox.open(html);
