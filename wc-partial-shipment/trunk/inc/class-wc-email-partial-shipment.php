...
if (!class_exists('WC_Email_Customer_Partial_shipment', false)):
	...
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound -- Custom plugin class.
	class WC_Email_Customer_Partial_shipment extends WC_Email
	{
		...
		public function __construct()
		{
			...
			$this->title          = __('Partial shipment order', 'wc-partial-shipment');
			$this->description    = __('This is an order notification sent to customers containing partially shipped order details.', 'wc-partial-shipment');
		...
		{
			return __('Your partially shipped order details', 'wc-partial-shipment');
		}
