...
class Wxp_Partial_Shipment_Settings
{
	...
	public static function get_settings()
	{
		...
		$settings = array(
			'section_title' => array(
				'name'     => __('Woocommerce Partial Shipment Settings', 'wc-partial-shipment'),
				'type'     => 'title',
				'id'       => 'wxp_partial_shipping_settings_section_title'
			),
			'partially_shipped' => array(
				'title'   => __('Add Status "Partially Shipped"', 'wc-partial-shipment'),
				'desc'    => __('Add new order status called "Partially Shipped".', 'wc-partial-shipment'),
				'id'      => 'partially_shipped_status',
				'type'    => 'checkbox',
				'default' => 'yes',
			),
			'auto_complete' => array(
				'title'   => __('Switch Status to "completed"', 'wc-partial-shipment'),
				'desc'    => __('Auto Switch order status to "completed", if all products are shipped.', 'wc-partial-shipment'),
				'id'      => 'partially_auto_complete',
				'type'    => 'checkbox',
				'default' => 'yes',
			),
			'partially_hide_status' => array(
				'title'   => __('Hide Status', 'wc-partial-shipment'),
				'desc'    => __('Hide status label on order detail page until products are not partially shipped.', 'wc-partial-shipment'),
				'id'      => 'partially_hide_status',
				'type'    => 'checkbox',
				'default' => 'yes',
			),
			'partially_enable_status_popup' => array(
				'title'   => __('Display status in order popup', 'wc-partial-shipment'),
				'desc'    => __('Display status in order popup at order list page.', 'wc-partial-shipment'),
