...
<h2>
	...
	echo wp_kses_post($before . sprintf(__('[Order #%s]', 'wc-partial-shipment') . $after . ' (<time datetime="%s">%s</time>)', $order->get_order_number(), $order->get_date_created()->format('c'), wc_format_datetime($order->get_date_created())));
	?>
</h2>
	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		...
		<tfoot>
			...
			if ($order->get_customer_note()) {
				?>
				<tr>
					<th class="td" scope="row" colspan="3" style="text-align:<?php echo esc_attr($text_align); ?>;"><?php esc_html_e('Note:', 'wc-partial-shipment'); ?></th>
